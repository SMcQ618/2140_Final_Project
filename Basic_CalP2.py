...
e = tk.Entry(root, width = 35, boarderwidth = 5)
...
button_equal = tk.Button(root, text = "=", padx = 85, pady = 20, command = lambda: button_click())
button_clear = tk.Button(root, text = "Clear", padx = 59, pady = 20, command=lambda: button_click())
